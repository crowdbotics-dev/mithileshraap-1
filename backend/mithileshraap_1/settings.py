"""
Django settings for mithileshraap_1 project.
...
ROOT_URLCONF = 'mithileshraap_1.urls'
...
WSGI_APPLICATION = 'mithileshraap_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithileshraap_1 API",
    "DESCRIPTION": "API documentation for mithileshraap_1 App",
    "VERSION": "v1",
}
